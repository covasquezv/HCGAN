...
def read_data_original_irr(file):
	...
	#print(data[0].keys())
	calculate_amplitudes(data[0], 'original_magnitude')
	...
	calculate_amplitudes(data[1], 'original_magnitude')
	...
	calculate_amplitudes(data[2], 'original_magnitude')
...
X_trainR, y_trainR, A_trainR, X_valR, y_valR, A_valR, X_testR, y_testR, A_testR  = read_data_original_irr('TSTR_data/datasets_original/REAL/'+ dataset_real +'.pkl')
